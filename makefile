...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  msqueue.o register.o server.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#
...
#^|
msqueue.o: /cygdrive/C/eclipse/workspace/test/msqueue.cpp \
 /cygdrive/C/eclipse/workspace/test/msqueue.h \
...
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/test/server.h \
